    ...
    <div class="card">
      <div class="card-body">
        <form action="product/update/<?= $products->id ?>" method="POST">
          ...
          <div class="form-group">
            <h6>Nama</h6>
            <input value="<?= $products->nama_product ?>" type=" text" class="form-control" name="nama_product" placeholder="Masukkan Nama Product">
          </div>
          <div class="form-group">
            <h6>Description Product</h6>
            <textarea value="<?= $products->desc_product ?>" class="form-control" name="desc_product" rows="4" placeholder="Masukkan Deskripsi"></textarea>
          </div>
